...
Each module includes a request.http file containing example API requests. You can use these files with the REST Client extension in VS Code to easily test the API endpoints.
